...
modBasic <- lmer(logY.rs ~ logSc*log(Tscale) + (1 + logSc|ExptA) +  (1 + logSc|Expt) +  (1 + logSc|Study), data=data, REML = FALSE, na.action=na.omit)
modBasici <- lmer(logY.rs ~ logSc*log(Tscale) +  (1|ExptA)  +  (1|Expt) + (1|Study), data=data, REML = FALSE, na.action=na.omit)
...
modBasiciv <- lmer(logY.rs ~ logSc*log(Tscale) +  (1 + logSc|ExptA) , data=data, REML = FALSE, na.action=na.omit)


# basic2 (The level-1 model w/ time and logSc)
modBasic2 <- lmer(logY.rs ~ logSc+log(Tscale) + (1 + logSc|ExptA) + (1 + logSc|Expt) + (1 + logSc|Study), data=data, REML = FALSE, na.action=na.omit)
modBasic2i <- lmer(logY.rs ~ logSc+log(Tscale) + (1|ExptA) + (1|Expt) + (1|Study), data=data, REML = FALSE, na.action=na.omit)
...
modBasic2iv <- lmer(logY.rs ~ logSc+log(Tscale) +  (1 + logSc|ExptA) , data=data, REML = FALSE, na.action=na.omit)

# basic3 (The level-1 model w/ logSc)
modBasic3 <- lmer(logY.rs ~ logSc + (1 + logSc|ExptA) + (1 + logSc|Expt) + (1 + logSc|Study), data=data, REML = FALSE, na.action=na.omit)
modBasic3i <- lmer(logY.rs ~ logSc + (1|ExptA) + (1|Expt) + (1|Study), data=data, REML = FALSE, na.action=na.omit)
...
modBasic3iv <- lmer(logY.rs ~ logSc +  (1 + logSc|ExptA) , data=data, REML = FALSE, na.action=na.omit)
...
## comparison of best level 1 model  (numbers reflect numbers from main text): 
#old name: modBasic
mod1 <- lmer(logY.rs ~ logSc*log(Tscale) + (1 + logSc|ExptA) +  (1 + logSc|Expt) +  (1 + logSc|Study), data=data, REML = TRUE, na.action=na.omit)
#old name: modBasic2
mod2 <- lmer(logY.rs ~ logSc+log(Tscale) + (1 + logSc|ExptA) + (1 + logSc|Expt) + (1 + logSc|Study), data=data, REML = TRUE, na.action=na.omit)
#old name: modBasic3
mod3 <- lmer(logY.rs ~ logSc + (1 + logSc|ExptA) + (1 + logSc|Expt) + (1 + logSc|Study), data=data, REML = TRUE, na.action=na.omit)
...
mod4 <- lmer(logY.rs ~ logSc*Sys1*TG1 + (1 + logSc|Entry) + (1 + logSc|ExptA) + (1 + logSc|Study), data=data, REML = TRUE, na.action=na.omit)

mod4.1 <- lmer(logY.rs ~ log(Tscale) + logSc*Sys1*TG1 + (1 + logSc|Entry) + (1 + logSc|ExptA) + (1 + logSc|Study), data=data, REML = TRUE, na.action=na.omit)
...
mod5 <- lmer(logY.rs ~ logSc*Sys1*TG1  + logSc*restrt + (1 + logSc|Entry) + (1 + logSc|ExptA) + (1 + logSc|Study), data=data, REML = TRUE, na.action=na.omit)

mod6 <- lmer(logY.rs ~ logSc*Sys1*TG1 + logSc*restrt + logSc*log(MaxTscale+1) + (1 + logSc|Entry) + (1 + logSc|ExptA) + (1 + logSc|Study), data=data, REML = TRUE, na.action=na.omit)
...
mod7 <- lmer(logY.rs ~ logSc*restrt + logSc*log(MaxTscale+1) + (1 + logSc|Entry) + (1 + logSc|ExptA) + (1 + logSc|Study), data=data, REML = TRUE, na.action=na.omit)
...
model.sel(mod4, mod4.1, mod4.2, mod5, mod6, mod6.1, mod7, mod7.1, mod8, mod9, mod9.1, mod9.2)
